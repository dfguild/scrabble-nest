...
var MoveGateway = /** @class */ (function () {
    function MoveGateway(pgStore) {
        this.pgStore = pgStore;
        this.logger = new common_1.Logger();
    }
    MoveGateway.prototype.onGameStart = function (client, g) {
        return __awaiter(this, void 0, void 0, function () {
            var gameDto;
            return __generator(this, function (_a) {
                gameDto = this.pgStore.getGame(g.game).getGameDto();
    ...
    MoveGateway.prototype.onGameMove = function (client, g) {
        return __awaiter(this, void 0, void 0, function () {
            var game;
            return __generator(this, function (_a) {
                game = this.pgStore.getGame(g.gameName);
                game.updateGame(g);
    ...
    MoveGateway.prototype.sendUpdateGameResponse = function (client, turn) {
        client.emit('gameUpdateResponse', turn);
    };
    MoveGateway.prototype.onGameJoin = function (gInDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    MoveGateway.prototype.sendGameDto = function (g, socket) {
